...
It is set to run at 4am local timezone every day and will update any row that has done checked and a due date that is that day or earlier and update by the number of days in the interval property.
